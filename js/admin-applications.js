            ...
            <tr style="${isSelected ? 'background: #f0f9ff;' : ''}${app.deleted || isInactive ? 'opacity: 0.55;' : ''}">
                ...
                <td style="font-size: 12px; color: #64748b; line-height: 1.5;">
                    ...
                    ${app.extension_enabled && app.extension_start_date
                        ? `<div style="white-space:nowrap; margin-top:2px;"><span style="color:#2563eb; font-weight:600;">첨삭2</span> ${formatDateWithDay(app.extension_start_date)} ${getDday(app.extension_start_date)}</div>`
                        : ''}
                </td>
                <td>
